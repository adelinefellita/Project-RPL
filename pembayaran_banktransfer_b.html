    ...
    <body>
        ...
        <div class="container-2">
            <table class="metode-payment-box" border="0">
                ...
                <tr>
                    <td colspan="2"><div class="continue-shop-button"><div class="continue-shop-text">Pembayaran Anda telah Berhasil !<br>silahkan ambil pesanan di outlet pukul 15.30</div></div></td>
                </tr>
            </table>
        </div>
