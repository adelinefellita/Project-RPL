...
<body>
    ...
    <div class="beverage_title">
        <table class="baverage-table" border="0">
            <tr>
                <td class="our_beverage">BLENDED COFFEE<hr></td>  
            </tr>
        </table>
    </div>
    <div class="content">
        <table class="content-table" border="0">
            <tr>
                <td>
                    <div class="box">
                        <div class="product-name">Caramel Frappuccino</div>
                        <div class="product-price">Rp40.000</div>
                        <img src="./assets/blended-coffee/caramel-frappucino.jpg" class="product-pic">
                    </div>
                </td>
                <td>
                    <div class="box">
                        <div class="product-name">Java Chip Frappuccino</div>
                        <div class="product-price">Rp40.000</div>
                        <img src="./assets/blended-coffee/caramel-java-chip-frappuccino.jpg" class="product-pic">
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="box">
                        <div class="product-name">Coffee Frappuccino</div>
                        <div class="product-price">Rp40.000</div>
                        <img src="./assets/blended-coffee/coffee-frappuccino.jpg" class="product-pic">
                    </div>
                </td>
                <td>
                    <div class="box">
                        <div class="product-name">Java Chip Frappuccino</div>
                        <div class="product-price">Rp40.000</div>
                        <img src="./assets/blended-coffee/java-chip-frappucino.jpg" class="product-pic">
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="box">
                        <div class="product-name">Mocha Frappuccino</div>
                        <div class="product-price">Rp40.000</div>
                        <img src="./assets/blended-coffee/mocha-frappucino.jpg" class="product-pic">
                    </div>
                </td>
            </tr>
        </table>
